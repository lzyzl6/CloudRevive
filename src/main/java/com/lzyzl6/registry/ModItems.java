...
public class ModItems {
    ...
    static List<FoodProperties.PossibleEffect> QI_EFFECTS = List.of(
    ...
    static List<FoodProperties.PossibleEffect> SOUL_EFFECTS = List.of(
    ...
    public static final Item SOUL_FRUIT = register(
            "soul_fruit",
            new SoulFruit(new Item.Properties()
                    .fireResistant()
