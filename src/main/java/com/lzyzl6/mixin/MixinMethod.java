    ...
    public static void handle(Player player) {
                    ...
                    for (AccessoriesContainer accessoriesContainer : container) {
                        for (int i = 0; i < accessoriesContainer.getSize(); i++) {
                            ...
                            for (int j = 0; j < cosmicContainer.getContainerSize(); j++) {
                                ItemStack itemStack = cosmicContainer.removeItem(j, cosmicContainer.getItem(j).getCount());
        ...
        if (isCuriosInstalled()) {
            ...
            if (maybeCuriosInventory.isPresent()) {
                ...
                //装备槽
                net.neoforged.neoforge.items.IItemHandlerModifiable equippedCurios = curiosInventory.getEquippedCurios();
